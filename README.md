...
- `src/module_3.py` — задачи и решения по теме 3
- `tests/test_m_3_1.py` — тесты к задачам 3.1
...
- `src/module_4.py` — задачи и решения по теме 4
- `tests/test_m_4_1.py` — тесты к задачам 4.1
