...
### Модуль 2. Освежаем базовые знания Python

- `src/module_2.py`, `tests/test_m_2_1.py` — задачи, решения и тесты по теме **2.1 Объявление переменных, ввод (input()) и вывод (print())**
- `src/module_2.py`, `tests/test_m_2_2.py` — задачи, решения и тесты по теме **2.2 Основные типы данных (int, float, str, bool)**
- `src/module_2.py`, `tests/test_m_2_3.py` — задачи, решения и тесты по теме **2.3 Работа со строками: индексация, методы, форматирование**
- `src/module_2.py`, `tests/test_m_2_4.py` — задачи, решения и тесты по теме **2.4 Условные и логические операторы**
- `src/module_2.py`, `tests/test_m_2_5.py` — задачи, решения и тесты по теме **2.5 Циклы: for, while, использование break и continue**
- `src/module_2.py`, `tests/test_m_2_6.py` — задачи, решения и тесты по теме **2.6 Списки**

### Модуль 3. Практические задания

- `src/module_3.py`, `tests/test_m_3_1.py` — задачи, решения и тесты по теме **3.1 Клад Чёрного Кракена**

### Модуль 4. Работа с функциями. Начало

- `src/module_4.py`, `tests/test_m_4_1.py` — задачи, решения и тесты по теме **4.1 Что такое функции. Их объявление и вызов**
- `src/module_4.py`, `tests/test_m_4_2.py` — задачи, решения и тесты по теме **4.2 Оператор return**
- `src/module_4.py`, `tests/test_m_4_3.py` — задачи, решения и тесты по теме **4.3 Именованные аргументы: формальные и фактические параметры**
